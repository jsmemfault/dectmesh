...
9p -a unix!/tmp/9p.sock write /dev/fw9151 < dect_mesh/build_thingy/dect_mesh/zephyr/zephyr.signed.bin
...
np write /dev/fw9151 < dect_mesh/build_thingy/dect_mesh/zephyr/zephyr.signed.bin   # OTA stream
